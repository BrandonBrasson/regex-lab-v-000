...
puts describe "Working with Regular expressions" do
  describe "#starts_with_a_vowel?" do
    ...
    puts it "returns false for words starting with a consonant" do
  ...
  puts describe "#words_starting_with_un_and_ending_with_ing" do
  ...
  puts describe "#words_five_letters_long" do
  ...
  puts describe "#first_word_capitalized_and_ends_with_punctuation?" do
    ...
    puts it "Returns false for text starting with an uncapitalized letter but ending with puncutation" do
    ...
    puts it "Returns false for text starting with a capital letter but ending without puncutation" do
      incorrect_punctuation = "Did you hear about the guy whose whole left side was cut off? He's all right now"
      expect(first_word_capitalized_and_ends_with_punctuation?(incorrect_punctuation)).to eq(false)
    end
    puts it "Returns false for text starting without a capital letter and ending without puncutation" do
...
"
  ...
  puts describe "#valid_phone_number?" do
    ...
    puts it "returns false for invalid phone numbers, regardless of formatting" do
